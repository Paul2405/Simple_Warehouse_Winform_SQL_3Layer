...
namespace Project
{
    public partial class ManageProduct : Form
    {
        ...
        private void DgvView_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Data table is empty", "Warning");
            }
            else
            {
                ...
                {
                    txtProductName.Text = listPro.ElementAt(index).ProductName;
                    txtDescription.Text = listPro.ElementAt(index).Description;
