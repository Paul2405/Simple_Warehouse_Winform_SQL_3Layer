...
namespace Project
{
    public partial class frmImport : Form
    {
        ...
        private void BtnImport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please choose a product to import!", "Warning");
            }
            else if (ValidateChildren(ValidationConstraints.Enabled))
            {
                ...
                bool checkUpdateProduct = ProDAO.updateProduct(numberPackage + numpackeLast, numSub, price, id);
                bool checkInsertIntoImport = importDAO.insertImport(ip);
                if (checkUpdateProduct && checkInsertIntoImport)
                {
                    MessageBox.Show("Import successfull", "Notification");
                ...
                {
                    MessageBox.Show("Import fail", "Warning");
